...
const Hero = () => {
  ...
  useEffect(() => {
    ...
    const crossfadeToFreshStart = () => {
      ...
      const nextActiveVideo = activeVideoRef.current === 'primary' ? 'secondary' : 'primary';
      const currentVideo = activeVideoRef.current === 'primary' ? primaryVideo : secondaryVideo;
      const nextVideo = nextActiveVideo === 'primary' ? primaryVideo : secondaryVideo;
    ...
    const monitorLoopPoint = () => {
      const video = activeVideoRef.current === 'primary' ? primaryVideo : secondaryVideo;
  ...
  return (
    <section className={`
      ...
      `}>
        <video 
          ref={primaryVideoRef}
          className={activeVideo === 'primary' ? 'hero-video hero-video-active' : 'hero-video'}
          autoPlay 
          muted 
          playsInline
          preload="auto"
        ...
        <video 
          ...
          className={activeVideo === 'secondary' ? 'hero-video hero-video-active' : 'hero-video'}
          muted 
          playsInline
          preload="auto"
          aria-hidden="true"
