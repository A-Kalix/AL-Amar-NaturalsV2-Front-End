 ...
 * @description Provides an organic SVG wave transition between major page sections with a floating brand seal.
 * @param {boolean} [flip=false] - Whether the divider should be vertically flipped.
 */
const SectionDivider = ({ flip = false }) => {
  return (
    <div className={`section-divider ${flip ? "divider-flipped" : ""}`}>
      <svg
