...
const PromiseIcon = ({ icon }) => {
  ...
  if (icon === "organic") {
    return (
      ...
      >
        <path
          d="M32 56C32 56 14 44 14 28C14 18 22 10 32 10C42 10 50 18 50 28C50 44 32 56 32 56Z"
          strokeWidth="2"
          strokeLinecap="round"
        ...
        />
        <path
          d="M32 30C32 30 22 24 20 16"
          strokeWidth="2"
          strokeLinecap="round"
        />
        <path
          d="M32 36C32 36 42 30 44 20"
          strokeWidth="2"
          strokeLinecap="round"
        />
      </svg>
  ...
  if (icon === "drop") {
    return (
      ...
      >
        <path
          d="M32 8C32 8 16 26 16 38C16 47.941 23.163 56 32 56C40.837 56 48 47.941 48 38C48 26 32 8 32 8Z"
          strokeWidth="2"
          strokeLinecap="round"
          strokeLinejoin="round"
        />
        <path
          d="M24 40C24 44.418 27.582 48 32 48"
          strokeWidth="2"
          strokeLinecap="round"
        />
      </svg>
  ...
  if (icon === "leaf") {
    return (
      ...
      >
        <path
          d="M32 52C32 52 12 40 12 26C12 18.268 18.268 12 26 12C28.8 12 31.4 12.9 33.6 14.5C35.8 12.9 38.4 12 42 12C49.732 12 56 18.268 56 26C56 40 32 52 32 52Z"
          strokeWidth="2"
          strokeLinecap="round"
          strokeLinejoin="round"
        />
