  ...
  return (
    <section className={`
      ...
      `}>
        <h2 className={`
        feel-title
      `}>How Do You Want To Feel?</h2>
        <p className={`
        feel-copy
      `}>
          Whether you need a quiet reset or everyday clarity, we have a ritual that fits.
        </p>
      </div>
      ...
      `} aria-label={article.headline}>
              <img src={article.image} alt={article.headline} className={`
        blog-image
      `} />
            </a>
            <div className={`
