  ...
  return (
    <section className={`
      ...
      `}>
        <h2 className={`
        testi-title
      `}>What our community is saying</h2>
        <div className={`
        testi-aggregate
      `}>
          <Stars count={5} />
      ...
      `} viewBox="0 0 16 16" fill="none" aria-hidden="true">
              <rect width="16" height="16" rx="3" fill="#6b6b4c"/>
      ...
      `}>
        {REVIEWS.map((review) => (
          <article key={review.id} className={`
        review-card
      `}>
            <div className={`
        review-image-wrap
      ...
      `} viewBox="0 0 16 16" fill="none" aria-label="Verified reviewer">
                    <rect width="16" height="16" rx="8" fill="#6b6b4c"/>
                    <path d="M4 8.5L6.5 11L12 5.5" stroke="white" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                )}
              </div>
              <span className={`
