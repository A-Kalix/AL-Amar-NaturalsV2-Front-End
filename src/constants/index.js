  ...
  items: [
    {
      title: 'Odor Control',
      href: '#products',
      iconPath: 'M36 8c-10 5-17 16-17 26 0 9 6 15 14 15 7 0 13-5 13-13 0-7-4-12-10-16 1 8-3 13-9 16'
    },
    {
      title: 'Sensitive Skin',
      href: '#products',
      iconPath: 'M25 44c-8-6-12-13-12-21 0-7 5-13 12-13 5 0 8 3 11 8 2-3 5-5 9-5 5 0 9 4 9 10 0 8-8 16-21 25'
    },
    {
      title: 'Daily Balance',
      href: '#journal',
      iconPath: 'M14 31c7-13 22-18 36-15-1 14-9 27-23 32 2-9 8-17 17-24-11 4-20 10-30 19'
    }
  ]
};
...
export const HERO_COPY = {
  ...
  ctaText: 'Shop Now',
  promise: 'Skincare that stays balanced, healthy, and respected through the merger of botanical power and pharmaceutical precision.'
};

export const SCIENCE_MEETS_NATURE = {
  headline: 'Where Science Meets Nature',
  intro: 'At Alamar Naturals, we believe that nature is most effective when refined by research.',
  points: [
    {
...
export const PRODUCTS = [
  {
    ...
    formula: 'A high-performance, skin-friendly blend that focuses on neutralizing odor molecules while maintaining total skin comfort.',
    botanicals: [
      { name: 'Bisabolol', desc: 'A natural wonder used for its profound soothing care on delicate underarm skin.' },
      { name: 'Sodium Bicarbonate', desc: 'Provides reliable, long-lasting freshness by working with your body’s natural rhythm.' },
      { name: 'Floral Herbs Aroma', desc: 'A refreshing, natural scent derived from botanical extracts.' }
    ],
  ...
  },
  {
    ...
    formula: 'A gentle, pH-balanced daily cleanser designed to remove impurities while actively preserving your skin’s natural balance.',
    botanicals: [
      { name: 'Prebiotic Inulin', desc: 'Enriched with this plant-derived "superfood" to support and nourish your skin’s healthy microbiome.' },
      { name: 'Rose & Chamomile Water', desc: 'A soothing base of Rosa Damascena and Chamomilla Recutita waters to refresh and calm sensitive skin.' },
      { name: 'Balanced Precision', desc: 'Optimized for delicate facial skin, leaving it feeling soft and hydrated—never stripped or tight.' }
    ],
...
export const EXPERTISE = {
  ...
  content: 'Alamar Naturals bridges the gap between clinical research and pharmaceutical formulation.',
  points: [
    {
...
export const PROMISES = [
  { id: 'organic', icon: 'organic', title: 'Organic', subtitle: 'Clean botanical direction.' },
  { id: 'pure-natural', icon: 'drop', title: '100% Pure & Natural', subtitle: 'Only thoughtful, botanical-led essentials.' },
  { id: 'cruelty-free', icon: 'leaf', title: 'Vegan Friendly & Cruelty Free', subtitle: 'Always tested on humans, never on animals.' },
  { id: 'made-in-italy', icon: 'italy', title: 'Made in Italy', subtitle: 'Italian craftsmanship and quality.' }
];

export const TESTIMONIAL = {
  name: 'Al-Amar Community',
  product: 'Pure Aura & Calm Pure',
  quote: 'The formulas feel considered from the first use. Pure Aura keeps the day fresh without heaviness, and Calm Pure leaves skin comfortable instead of tight.',
...
export const ARTICLES = [
  {
    id: 'prebiotics',
    headline: 'Beyond Surface Level: How Prebiotic Inulin Supports Your Skin’s Microbiome.',
    summary: 'True skin health begins with balance. Discover how we use prebiotic inulin to nourish your skin’s natural defenses and maintain long-term harmony.',
  ...
  },
  {
    ...
    summary: 'Understanding how botanical extracts and Bisabolol work with your body\'s natural processes to control odor while providing soothing care for delicate skin.',
  ...
  },
  {
    ...
    summary: 'Cleansing should restore clarity, not disturb your skin’s natural pH. Explore the pharmaceutical precision behind our Calm Pure Face Cleanser.',
    cta: 'Learn More',
    image: '/assets/lifestyle-4.png'
  },
  {
    id: 'standard',
    headline: 'Merging Nature and Science: The Future of Highly Effective Skincare.',
    summary: 'Learn how we bridge the gap between clinical research and pharmaceutical formulation to create products you can trust.',
    cta: 'Our Philosophy',
    image: '/assets/lifestyle-5.png'
  }
];
